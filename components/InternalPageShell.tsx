    ...
    <main className="min-h-screen bg-[#fffaf0] text-slate-900">
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16">
          ...
          <h1 className="mt-4 text-5xl font-bold tracking-tight text-white">{title}</h1>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Link href={`/${locale}/book-now`} className="rounded-full bg-[#FEE569] px-5 py-3 text-sm font-bold text-white">
